...
| Antigravity        | `--agent antigravity`             | Install the `agy` CLI and sign in first.                                                                                                                                            | `gnhf` invokes `agy` directly in headless mode with `--output-schema` pointing at the run's schema file.                                                                                                                                                                                                    |
